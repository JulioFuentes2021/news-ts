    ...
    >
      <div className="w-full flex justify-end">
        <section
          ...
          className="hover:border-blue-500 hover:text-blue-500 cursor-pointer border-4 border-white text-white w-8 flex place-content-center font-extrabold mx-4 mt-4"
        >
